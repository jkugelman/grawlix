...
import {
  ...
  configureResultCacheForTest, resultCacheStateForTest, configurePrefixCacheForTest, prefixCacheStateForTest, configurePartialCacheForTest, partialCacheStateForTest, configureArtifactCacheForTest, artifactCacheStateForTest, retainedResultInfoForTest,
...
const __grawlixTest = {
  ...
  prefixCacheState: () => prefixCacheStateForTest(),
  configurePartialCacheForTest: (opts = {}) => configurePartialCacheForTest(opts),
  partialCacheState: () => partialCacheStateForTest(),
  configureArtifactCacheForTest: (opts = {}) => configureArtifactCacheForTest(opts),
  artifactCacheState: () => artifactCacheStateForTest(),
  retainedResultInfo: () => retainedResultInfoForTest(),
  ...
  async exportText(format) {
    ...
    if (format === 'wordlist')      return buildWordlistText(rows, grouped, getOutputFormat(), getTrashScore());

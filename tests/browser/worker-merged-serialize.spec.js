...
const FORMATS = {
  rich:     { spaces: true, punctuation: true, digits: true, diacritics: true, symbols: true, comments: true },
  noAccent: { spaces: true, punctuation: true, digits: true, diacritics: false, symbols: true, comments: true },
  noSpace:  { spaces: false, punctuation: true, digits: true, diacritics: true, symbols: true, comments: true },
  stripped: { spaces: false, punctuation: false, digits: true, diacritics: false, symbols: true, comments: true },
  noComment:{ spaces: true, punctuation: true, digits: true, diacritics: true, symbols: true, comments: false },
};

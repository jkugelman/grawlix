...
- **Manage sources / Sync & backup dialogs on mobile.** Today these are desktop modals. On mobile they'd presumably go full-screen — at which point they're effectively routes. Worth revisiting "Setup as routes" specifically for mobile — see [`app.md`](../app.md) "Open: setup as routes."

...
The dialog is distinct from the **Wordlists** dialog: that one answers "what wordlists do I have, in what order, with what rules"; this one answers "how is my data being preserved across time and devices."

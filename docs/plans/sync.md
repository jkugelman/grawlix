...
The dialog is distinct from **Manage sources** (see `../designs/app.md`): that one answers "what lists do I have, in what order, with what rules"; this one answers "how is my data being preserved across time and devices."

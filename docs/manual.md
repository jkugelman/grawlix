...
- **Junk score** — The score given to an entry's leftover when you rename it but a copy still lives in another wordlist Grawlix can't delete (see *Editing entries*). Defaults to 0.
